ABSTRACT_GENERATION_TEMPLATE =  """
   <role>
    ...
    <task>
    Task
    Using the framework and examples provided, generate an abstract for a research paper on Responsible AI. Ensure that your abstract is concise, follows the structure outlined, and includes all necessary components. 
